...
if __name__ == '__main__':
    train_subject = [k for k in range(1,4)]
    test_subject = [k for k in range(1,4)]
    train_dataset = data_gen_train(train_subject)
    test_dataset = data_gen_eval(test_subject)
    ...
    sio.savemat('../data/intra_sub/intra_subject_data.mat', {"train_x": train_X, "train_y": train_y, "test_x": test_X, "test_y": test_y})
